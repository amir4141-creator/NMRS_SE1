    ...
    MainFrame mainFrame = new MainFrame() {
        ...
        protected boolean signUpActionLoginPanel(String userName, String passWord , Role role) {
            ...
            if(role == Role.CUSTOMER)
                isPublisher = false;
            signUp(userName,passWord,isPublisher);
        }
        ...
        @Override
        protected void postActionPostPanel(Content content) {
            data.getOnlineCustomer().subscribe(content);
        }

        @Override
        protected void deleteActionProfilePanel() {
            data.getCustomers().remove(data.getOnlineCustomer());
        }

        @Override
        protected boolean changeNameActionProfilePanel(String nawName) {
            data.getOnlineCustomer().setUserName(nawName);
            return true;
        }
